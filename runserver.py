...
@app.route("/top10_urls", methods=["GET"])
def get_top10_urls():
    try:
...
@app.route("/top10_src_ips", methods=["GET"])
...
@app.route("/android_ios_count", methods=["GET"])
...
@app.route("/android_ios_versions_count", methods=["GET"])
